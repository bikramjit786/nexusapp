...
const PLACEHOLDER_OUTPUT = "Your AI-generated story or song will appear here...";
function AIWriterPage() {
  const [prompt, setPrompt] = reactExports.useState("");
  const [output, setOutput] = reactExports.useState(PLACEHOLDER_OUTPUT);
...
The Nexus sings of innovation, of moments crystallized in verse. May your creativity never dim.`
    ...
    setTimeout(() => {
      var _a2;
      (_a2 = outputRef.current) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth", block: "start" });
    }, 100);
  };
  const isPlaceholder = output === PLACEHOLDER_OUTPUT;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-[calc(100vh-72px)] bg-background flex flex-col px-5 pt-8 pb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/15 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-5 h-5 text-primary", "aria-hidden": true }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h1",
          {
            className: "text-2xl font-bold text-primary font-display tracking-tight leading-tight",
            "data-ocid": "ai_writer.title",
            children: "AI Lyricist & Storyteller"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground ml-[52px]", children: "Generate poems, stories, or song lyrics with AI" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-3 top-3.5 z-10 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PenLine, { className: "w-4 h-4 text-primary opacity-70", "aria-hidden": true }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Textarea,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-5 h-5", "aria-hidden": true }),
          "Generate"
        ]
      }
    ),
        ...
        children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Generating your content…" })
            ] })
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            className: `text-sm leading-relaxed whitespace-pre-wrap break-words ${isPlaceholder ? "text-muted-foreground italic" : "text-foreground"}`,
            children: output
          }
        )
      }
...
function ChannelPage() {
  const [subscribed, setSubscribed] = reactExports.useState(/* @__PURE__ */ new Set());
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TvMinimal, { className: "w-7 h-7 text-primary shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-primary font-display tracking-tight", children: "Trending Channels" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-6 pl-10", children: "Discover and subscribe to top creators" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-3", "data-ocid": "channel.list", children: CHANNELS.map((channel, index2) => {
          const { id, name, subscribers, Icon: Icon2, accentColor, bgColor } = channel;
          const isSubscribed = subscribed.has(id);
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
              "data-ocid": `channel.item.${index2 + 1}`,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground text-[17px] font-semibold leading-tight truncate", children: name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-0.5", children: subscribers })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    "data-ocid": `channel.subscribe_button.${index2 + 1}`,
                    className: `shrink-0 px-4 py-1.5 rounded-full text-sm font-semibold transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${isSubscribed ? "bg-muted text-muted-foreground" : "bg-primary text-background hover:opacity-90 active:scale-95"}`,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-1 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Store, { className: "w-7 h-7 shrink-0", style: { color: "#ff5252" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-5", style: { color: "rgba(255,255,255,0.55)" }, children: "Buy and sell digital goods, merch & more" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-5 h-5 shrink-0", style: { color: "#888888" } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
        ...
        filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "w-12 h-12", style: { color: "#333333" } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "No products found" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", "data-ocid": "marketplace.list", children: filtered.map((product, index2) => {
          const Icon2 = product.icon;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": `marketplace.item.${index2 + 1}`,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    type: "button",
                    "data-ocid": `marketplace.buy_button.${index2 + 1}`,
...
function StatCol({ label, value, ocid }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", "data-ocid": ocid, children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-primary mb-7", "data-ocid": "profile.bio", children: "Nexus Creator • AI Enthusiast" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-around", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(StatCol, { label: "Posts", value: "47", ocid: "profile.stats.posts" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col", children: SETTINGS.map((setting, index2) => {
                const Icon2 = setting.icon;
                const isLast = index2 === SETTINGS.length - 1;
                    ...
                    "button",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Icon2,
                          {
                            className: `w-5 h-5 flex-shrink-0 ${setting.isLogout ? "text-primary" : "text-muted-foreground"}`
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            className: `flex-1 text-left text-[15px] font-medium ${setting.isLogout ? "text-primary" : "text-foreground"}`,
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          ChevronRight,
                          {
                            className: `w-4 h-4 flex-shrink-0 ${setting.isLogout ? "text-primary" : "text-muted-foreground"}`
                          }
                        )
                      ]
                    }
                  ),
                  !isLast && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-border opacity-60 mx-1" })
                ] }, setting.label);
              }) })
            ]
          }
...
const TABS = [
  ...
  { id: "channel", label: "Channel", icon: TvMinimal },
  { id: "profile", label: "Profile", icon: User }
];
function App() {
  const [activeTab, setActiveTab] = reactExports.useState("ai-writer");
  const renderPage = () => {
    switch (activeTab) {
      case "ai-writer":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(AIWriterPage, {});
      case "marketplace":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(MarketplacePage, {});
      case "channel":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ChannelPage, {});
      case "profile":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ProfilePage, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen overflow-hidden flex flex-col bg-background dark", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto overflow-x-hidden pb-20", children: renderPage() }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        className: "fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border",
        "data-ocid": "bottom_nav",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-around px-2 py-2 max-w-lg mx-auto", children: TABS.map((tab) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `flex flex-col items-center justify-center gap-1 px-4 py-2 rounded-xl transition-smooth min-w-[64px] ${isActive ? "text-primary" : "text-muted-foreground hover:text-foreground"}`,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Icon2,
                  {
                    className: `w-6 h-6 transition-smooth ${isActive ? "text-primary" : "text-muted-foreground"}`
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `text-[11px] font-medium leading-none transition-smooth ${isActive ? "text-primary" : "text-muted-foreground"}`,
                    children: tab.label
                  }
                )
              ]
